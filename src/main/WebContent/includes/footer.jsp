	...
	<footer>
		...
		<div class="footer-row">
			...
			<p class="footer-row-description">
				...
				<br /> <a href="${pageContext.request.contextPath}/negozio.jsp?cat=accessorio">Accessori</a><br /> <br />
				<a href="${pageContext.request.contextPath}/negozio.jsp?cat=felpe">Felpe</a><br /> <br />
			</p>
		</div>
	</footer>
</body>
